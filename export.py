...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/yolov5comp.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/exp92/weights/best.pt', help='model.pt path(s)')
